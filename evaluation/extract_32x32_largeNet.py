...
print ('Train set information: ',len(train_set_x), type(train_set_x[3]))
print ('Test set information: ',print (len(test_set_x), type(test_set_x[3]))
...
print ("Folds loaded:",print len(folds), type(folds), type(folds[0]), len(folds[0]),len(k_folds[0]), type(k_folds[0][0]), k_folds[0][0])
